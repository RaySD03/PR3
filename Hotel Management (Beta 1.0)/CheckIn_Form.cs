...
namespace Hotel_Management__Beta_1._0_
{
    public partial class CheckIn_Form : Form
    {
        ...
        public void performCheckIn()
        {
            ...
            // add Confirmation number to Data Base (To Be Implemented)
        ...
        private void OK_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Input fields are missing or contain numbers. Please try again.", " Error:", MessageBoxButtons.OK);
            }
        }
    }
}
